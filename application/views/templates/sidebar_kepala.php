    <div class="col-md-3 left_col">
      <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
          <a href="<?= base_url('admin/') ?>" class="site_title"><i class="fa fa-book"></i> <span> Arsip Surat</span></a>
        </div>
          ...
          <div class="menu_section">
            ...
            <ul class="nav side-menu">
              ...
              <li><a><i class="fa fa-users"></i> Surat Registrasi <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="<?= base_url('kepala/surat_registrasi') ?>"><i class="fa  fa-inbox"></i>Data Surat Registrasi</a></li>
                </ul>
              </li>
