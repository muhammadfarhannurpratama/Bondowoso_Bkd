    <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?= base_url('bagian/')?>" class="site_title"><i class="fa fa-institution"></i> <span> Arsip Surat</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-file-text"></i> Kategori Surat <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('bagian/surat_masuk') ?>"><i class="fa  fa-inbox"></i>Surat Masuk</a></li>
                      <li><a href="<?= base_url('bagian/surat_keluar') ?>"><i class="fa fa-send"></i>Surat Keluar</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-users"></i> Bagian <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('bagian/bagian') ?>"><i class="fa  fa-inbox"></i>Data Bagian</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
