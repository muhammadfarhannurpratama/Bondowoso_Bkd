            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <a href="<?= base_url('bagian/tambahSK')?>"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Surat Keluar</button></a>
                  </form>
                  <div class="x_content">
                  <div class="x_content">
                      ...
                      <?php foreach ($surat_keluar as $keluar) :?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                              ...
                              <a href="<?= base_url('bagian/unduhDisposisiSK/'.$keluar->id_suratkeluar) ?>"><button type="button" title="Unduh Disposisi" class="btn btn-info btn-xs"><i class="fa fa-download"></i></button></a>
                              ...
                              <a href="<?= base_url('bagian/editSK/'.$keluar->id_suratkeluar) ?>"><button type="button" title="Edit" class="btn btn-default btn-xs"><i class="fa fa-edit"></i></button></a>
                              <a onclick="return konfirmasi()" href="<?= base_url('bagian/hapusSK/'.$keluar->id_suratkeluar) ?>"><button type="button" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>
                              </td>
                        </tr>
                      <?php endforeach;?>
                      </tbody>
