                    ...
                    <div class="row">
                      ...
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <h3><a href="<?= base_url('bagian/surat_masuk') ?>" class="text-decoration-none">Surat Masuk</a></h3>
                      ...
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <h3><a href="<?= base_url('bagian/surat_keluar') ?>" class="text-decoration-none">Surat Keluar</a></h3>
                          <p>Telah Diarsipkan</p>
                        </div>
                      </div>
                      <!--
