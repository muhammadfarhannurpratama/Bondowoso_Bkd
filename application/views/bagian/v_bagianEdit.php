          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>bagian ><small>Edit Bagian</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="<?= base_url('bagian/bagian_proses_edit')?>"  method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?= $bagian->username_bagian_bagian?>" type="text" id="username_bagian_bagian" name="username_bagian_bagian" maxlength="50" placeholder="Masukkan Username bagian Bagian" class="form-control col-md-7 col-xs-12">
                            <small class="text-danger">
