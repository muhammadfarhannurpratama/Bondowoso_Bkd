...
<div class="right_col" role="main">
        ...
        <!--      <button type="submit" class="btn btn-success"><i class="fa fa-download"></i> Unduh Laporan Surat Keluar</button></a> -->
                  ...
                  <div class="x_content">
                    ...
                    <!--      <a href="<?= base_url('admin/unduhDisposisiSK/'.$keluar->id_suratkeluar) ?>"><button type="button" title="Unduh Disposisi" class="btn btn-info btn-xs"><i class="fa fa-download"></i></button></a> -->
                              <a href="<?= base_url('admin/detailSK/'.$keluar->id_suratkeluar) ?>"><button type="button" title="Detail Surat Keluar" class="btn btn-info btn-xs"><i class="fa fa-file-image-o"></i></button></a>
                              <a href="<?= base_url('admin/editSK/'.$keluar->id_suratkeluar) ?>"><button type="button" title="Edit" class="btn btn-default btn-xs"><i class="fa fa-edit"></i></button></a>
                              <a onclick="return konfirmasi()" href="<?= base_url('admin/hapusSK/'.$keluar->id_suratkeluar) ?>"><button type="button" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>
                              </td>
                        </tr>
                      <?php endforeach;?>
                      </tbody>
