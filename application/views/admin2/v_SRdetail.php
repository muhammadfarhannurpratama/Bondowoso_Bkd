            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr>
                    <td>File</td>
                    <td><a href="<?= base_url('assets/backend/surat_registrasi/' . $detail_SR->file_suratregistrasi) ?>"><b>Unduh File</b></a></td>
                  </tr>
                  <tr>
                    <td>Operator</td>
              ...
              <div class="text-right">
                <a href="<?= base_url('admin2/surat_registrasi') ?>" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
              </div>
