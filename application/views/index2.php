...
<body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><span class="logo-dec">ARSIP SURAT BKD Bondowoso</span></a>
                </div>
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a href="index">Beranda</a></li>
                        <li class="active"><a href="index2">Tentang</a></li>
                        <li class="active"><a href="<?= base_url('frontend/login'); ?>">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <footer id="footer">
        <div class="container">
            ...
            -->
                    Designed by <a href="https://bootstrapmade.com/">PKL 2021</a>
                </div>
            </div>
        </div>
    </footer>
