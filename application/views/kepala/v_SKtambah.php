            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form action="<?= base_url('kepala/tambah_prosesSK')?>"  name="formsuratkeluar" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class='input-group date' id='myDatepicker4'>
                            <input type='text' id="tanggalkeluar_suratkeluar" name="tanggalkeluar_suratkeluar"  class="form-control"  readonly="readonly" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" onkeyup="validAngka(this)" id="kode_suratkeluar" name="kode_suratkeluar"  maxlength="7" placeholder="Masukkan Kode Surat" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?= $nomor_suratkeluar ?>" type="text"  id="nomor_suratkeluar" name="nomor_suratkeluar"  maxlength="35" placeholder="Masukkan Nomor Urut Surat" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <fieldset>
                          <div class="control-group">
                            <div class="controls">
                                <input type="text" class="form-control has-feedback-left" id="single_cal3" name="tanggalsurat_suratkeluar" placeholder="First Name" aria-describedby="inputSuccess2Status3"  readonly="readonly">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="kepada_suratkeluar" name="kepada_suratkeluar"  placeholder="Masukkan Tujuan Surat" class="form-control col-md-7 col-xs-12">
                          <small class="text-danger">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea id="perihal_suratkeluar" name="perihal_suratkeluar"  class="form-control" rows="3" placeholder='Masukkan Perihal Surat'></textarea>
                          <small class="text-danger">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="<?= base_url('kepala/surat_keluar')?>"" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Batal</a>
