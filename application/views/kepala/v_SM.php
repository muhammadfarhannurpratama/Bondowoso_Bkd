    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <form action="<?= base_url('kepala/downloadlap_SM') ?>" name="download_suratmasuk" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
            ...
            <!-- <a href="<?= base_url('kepala/tambahSM') ?>"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Surat Masuk</button></a>
                  -->
          </form>
          <div class="x_content">
            <div class="x_content">
